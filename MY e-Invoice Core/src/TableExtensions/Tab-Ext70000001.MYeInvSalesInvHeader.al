tableextension 70000001 "MY eInv Sales Inv Header" extends "Sales Invoice Header"
{
    fields
    {
        ...
        {
            Caption = 'Error/Cancellation Message';
            DataClassification = CustomerContent;
            Editable = false;
        }
        ...
        field(70000016; "MY eInv Cancellation Date"; Date)
        {
            Caption = 'Cancellation Date';
            DataClassification = CustomerContent;
            Editable = false;
        }
        field(70000017; "MY eInv Cancellation Time"; Time)
        {
    ...
    begin
        DocumentProcessor.ProcessSalesInvoice(Rec);
    end;
